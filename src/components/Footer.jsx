...
const defaultSocials = [
  { name: "X (Twitter)", href: "https://x.com/yourhandle", key: "x" },
  { name: "Instagram",   href: "https://instagram.com/yourhandle", key: "ig" },
  { name: "YouTube",     href: "https://youtube.com/@yourhandle", key: "yt" },
  { name: "Facebook",    href: "https://facebook.com/yourhandle", key: "fb" },
  { name: "LinkedIn",    href: "https://linkedin.com/in/yourhandle", key: "li" },
];
    ...
    case "li":
      return (
        <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
          ...
          <path d="M6.5 18v-6.5H9V18H6.5zM12 18v-3.5a2 2 0 0 1 4 0V18h-2v-3.2a1 1 0 0 0-2 0V18h-2z" />
        </svg>
      );
    default:
      return null;
